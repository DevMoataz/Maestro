...
.."(🎥) #الفيديو "..(redis:get(hka3) or "false").."\n"
.."(↪️)#التوجيه"..(redis:get(hka2) or "false").."\n"
.."(〽️)#الـشارحه "..(redis:get(h_k_a8) or "false").."\n"
.."(🚫) #الروابط"..(redis:get(hka1) or "false").."\n\n"
.."(🌀)#المعرفات "..(redis:get(hka7) or "false").."\n"
